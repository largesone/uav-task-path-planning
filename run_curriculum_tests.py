...
# -*- coding: utf-8 -*-
"""
文件名: run_curriculum_tests.py
描述: 课程学习训练协调器测试运行脚本
作者: AI Assistant
日期: 2024

使用方法:
python run_curriculum_tests.py [--basic-only] [--unit-only] [--integration-only]
"""
...
def run_basic_tests():
    ...
    try:
        # 使用简化版本的测试
        import temp_tests.test_curriculum_training_simple as test_module
...
def run_unit_tests():
    ...
    try:
        import unittest
        import temp_tests.test_curriculum_training as test_module
...
def main():
    """主函数"""
    parser = argparse.ArgumentParser(description="课程学习训练协调器测试运行器")
